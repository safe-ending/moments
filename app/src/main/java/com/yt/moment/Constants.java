...
public class Constants {
    ...
    public final static String[] CONTENT = {
            "土地是以它它的肥沃和收获而被估价的也是土地，不过它生产的不是粮食，土地是以它的肥沃和收获而被估价的；才能也是土地，不过它生产的不是粮食，土地是以它的肥沃和收获而被估价的；才能也是土地，不过它生产的不是粮食，土地是以它的肥沃和收获而被估价的；才能也是土地，不过它生产的不是粮食，而是真理。如果只能滋生瞑想和幻想的话，即使再大的才能也只是砂地或盐池，那上面连小草也长不出来的。",
    ...
    public final static class FriendCircleType implements Serializable {
        //纯文字
    ...
    public final static class CommentType implements Serializable {
        //单一评论
    ...
    public final static class EmojiType implements Serializable {
        //单一评论
